                ...
                case (int)BurnsBac.WinApi.Windows.WindowsMessages.INPUT:
                    {
                        ...
                        if (ri.Header.dwType == RawInputDeviceType.Hid)
                        {
                            ...
                            var xval = hidResult.UsageValues.First(x => x.UsagePage == HidUsagePages.GenericDesktop && x.Usage == (uint)BurnsBac.WinApi.Hid.Usage.GenericDesktop.X);
                            var yval = hidResult.UsageValues.First(x => x.UsagePage == HidUsagePages.GenericDesktop && x.Usage == (uint)BurnsBac.WinApi.Hid.Usage.GenericDesktop.Y);
